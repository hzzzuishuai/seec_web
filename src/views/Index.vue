<template>
  <div>
    ...
    <!-- 表单 -->
    <MyDialog @my_cancel="cancelfn" :form="form" :formLabelWidth="formLabelWidth" :dialogFormVisible="dialogFormVisible" @confirmfn_my="confirmfn" ></MyDialog>
    <!-- 增加的弹窗 -->
    <MyDialog 
      :form="addfrom">
    </MyDialog>
...
import AddDailog from "@/components/AddDailog.vue"
    export default {
